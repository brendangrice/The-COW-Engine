...
void destroyBoardstate(Boardstate *bs); // destroys the boardstates generated by makeBoardState()
...
bool parseInput(Coord *from, Coord *to); //reads input and gives from and to as coordinates (0-63), returns -1 on quit, 0 on bad read, 1 on the first term being fully read, 2 on both terms being read 
